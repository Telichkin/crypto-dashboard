...
},{"mobx":18,"react":28,"react-dom":25}],18:[function(require,module,exports){
...
},{"./lib/ReactPropTypesSecret":22,"_process":20,"fbjs/lib/invariant":12,"fbjs/lib/warning":16}],22:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/EventListener":1,"fbjs/lib/ExecutionEnvironment":2,"fbjs/lib/containsNode":5,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/focusNode":8,"fbjs/lib/getActiveElement":9,"fbjs/lib/shallowEqual":15,"object-assign":19,"react":28}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":20,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":19,"prop-types/checkPropTypes":21}],27:[function(require,module,exports){
/** @license React v16.2.0
...
},{"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"object-assign":19}],28:[function(require,module,exports){
(function (process){
'use strict';
...
var default_1 = (function () {
    ...
    default_1.prototype.subscribe = function (callbacks) {
        setTimeout(function () {
...
var default_1 = (function () {
    function default_1(apiClient) {
        this.apiClient = apiClient;
        this.loading = true;
        this.exchanges = { "": "" };
        this.currentExchange = "";
        this.exchangesIsOpened = false;
        this.apiClient.subscribe({
            onConnect: this.init,
            onUpdate: this.update,
        });
    }
    default_1.prototype.init = function (exchanges) {
        this.update(exchanges);
        this.currentExchange = this.randomCurrentExchange;
        this.loading = false;
    };
    default_1.prototype.update = function (exchanges) {
        this.exchanges = exchanges;
    };
    Object.defineProperty(default_1.prototype, "randomCurrentExchange", {
        get: function () {
            var exchangesNames = Object.keys(this.exchanges);
            var randomIndex = Math.floor(exchangesNames.length * Math.random());
            return exchangesNames[randomIndex];
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(default_1.prototype, "currentExchangeRate", {
        get: function () {
    ...
    default_1.prototype.toggleExchangesList = function () {
        this.exchangesIsOpened = !this.exchangesIsOpened;
    };
    default_1.prototype.changeCurrentExchange = function (exchangeName) {
        var _this = this;
        return function () {
            _this.setCurrentExchange(exchangeName);
            _this.toggleExchangesList();
        };
    };
    default_1.prototype.setCurrentExchange = function (exchangeName) {
    ...
    __decorate([
        mobx_1.observable
    ], default_1.prototype, "exchanges", void 0);
    __decorate([
        mobx_1.observable
    ], default_1.prototype, "currentExchange", void 0);
    __decorate([
        mobx_1.observable
    ], default_1.prototype, "exchangesIsOpened", void 0);
    __decorate([
        mobx_1.action.bound
    ], default_1.prototype, "init", null);
    __decorate([
        mobx_1.action.bound
    ], default_1.prototype, "update", null);
    __decorate([
        mobx_1.computed
    ], default_1.prototype, "currentExchangeRate", null);
    __decorate([
        mobx_1.action.bound
    ], default_1.prototype, "toggleExchangesList", null);
    __decorate([
        mobx_1.action.bound
    ], default_1.prototype, "changeCurrentExchange", null);
    __decorate([
        mobx_1.action.bound
    ], default_1.prototype, "setCurrentExchange", null);
    return default_1;
}());
exports.default = default_1;

},{"mobx":18}],31:[function(require,module,exports){
"use strict";
...
var default_1 = (function (_super) {
    ...
    default_1.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "dashboard" },
            React.createElement("h1", { className: "dashboard__title" }, "Hi ETH! What is your exchange rate?"),
            model.loading ? this.renderLoading() : this.renderLoaded()));
    };
    default_1.prototype.renderLoading = function () {
        return (React.createElement("div", { className: "dashboard__description" }, "Wait a sec I'm thinking..."));
    };
    default_1.prototype.renderLoaded = function () {
        var model = this.props.model;
        return (React.createElement("div", { className: "dashboard__description" },
            "My exchange rate at ",
            React.createElement("div", { className: "dashboard__exchange" },
                React.createElement("span", { className: "dashboard__echange-name", onClick: model.toggleExchangesList }, model.currentExchange),
                model.exchangesIsOpened && this.renderExchanges()),
            " is ",
            React.createElement("span", { className: "dashboard__exchange-rate" }, model.currentExchangeRate + " for 1 ETH")));
    };
    default_1.prototype.renderExchanges = function () {
        var model = this.props.model;
        return (React.createElement("div", { className: "available-exchanges" },
            React.createElement("ul", { className: "available-exchanges__list" }, Object.keys(model.exchanges).map(function (exchangeName) { return (React.createElement("li", { className: "available-exchanges__item", key: exchangeName, onClick: model.changeCurrentExchange(exchangeName) }, exchangeName)); }))));
    };
...
},{"mobx-react":17,"react":28}],32:[function(require,module,exports){
"use strict";
...
var DashboardView_1 = __importDefault(require("./DashboardView"));
var Api_1 = __importDefault(require("./Api"));
var dashboard = new Dashboard_1.default(new Api_1.default());
react_dom_1.default.render(react_1.default.createElement(DashboardView_1.default, { model: dashboard }), document.getElementById("greet"));

},{"./Api":29,"./Dashboard":30,"./DashboardView":31,"react":28,"react-dom":25}]},{},[32]);
